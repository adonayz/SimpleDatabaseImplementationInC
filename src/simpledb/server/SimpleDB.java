 ...
 * {@link #init(String, int) init} before use.
 * The methods {@link #initFileMgr(String) initFileMgr},
 * {@link #initFileAndLogMgr(String) initFileAndLogMgr},
 * {@link #initFileLogAndBufferMgr(String, int) initFileLogAndBufferMgr},
...
public class SimpleDB {
   ...
   public static void init(String dirname) {
      initFileLogAndBufferMgr(dirname, 0); // CS4432-Project1: 0 means normal implementation, no policy
   ...
   //CS4432-Project1: I added this method so that I can add the policy functionality to the database
   /**
    * Initializes the system.
    * This method is called during system startup.
    * @param dirname the name of the database directory
    ...
    */
   public static void init(String dirname, int policy) {
   ...
   // CS4432-Project1: used to create a buffer manager that used additional replacement policies
   /**
    * Initializes the file, log, and buffer managers.
    * @param dirname the name of the database directory
    * @param policy replacement policy
    */
   public static void initFileLogAndBufferMgr(String dirname, int policy) {
